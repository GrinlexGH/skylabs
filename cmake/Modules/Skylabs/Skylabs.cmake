...
function(skylabs_configure_target target_name)
    ...
    set_target_properties(${target_name} PROPERTIES
        ...
        # Set paths to the libraries to RUNPATH so that
        # file(GET_RUNTIME_DEPENDENCIES) can find and copy .so files of
        # these libraries. Then it will restore RUNPATH
        INSTALL_RPATH_USE_LINK_PATH ON
        BUILD_WITH_INSTALL_RPATH ON
        INSTALL_RPATH "\$ORIGIN"

        PDB_OUTPUT_DIRECTORY ${SKYLABS_BIN_OUTPUT_DIRECTORY}
        COMPILE_PDB_OUTPUT_DIRECTORY ${SKYLABS_BIN_OUTPUT_DIRECTORY}
        RUNTIME_OUTPUT_DIRECTORY ${SKYLABS_BIN_OUTPUT_DIRECTORY}
        LIBRARY_OUTPUT_DIRECTORY ${SKYLABS_BIN_OUTPUT_DIRECTORY}
        ARCHIVE_OUTPUT_DIRECTORY ${SKYLABS_LIB_OUTPUT_DIRECTORY}
    )
